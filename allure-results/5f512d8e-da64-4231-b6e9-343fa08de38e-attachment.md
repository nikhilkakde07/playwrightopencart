...
```
Error: page.goto: net::ERR_HTTP2_PROTOCOL_ERROR at http://www.redbus.in/
Call log:
  - navigating to "http://www.redbus.in/", waiting until "load"
...
> 4  |   await page.goto('http://www.redbus.in/');
     |              ^ Error: page.goto: net::ERR_HTTP2_PROTOCOL_ERROR at http://www.redbus.in/
