...
- Name: apitests\gorest.spec.ts >> PUT- create new users
- Location: tests\apitests\gorest.spec.ts:44:5
...
```ts
  ...
  49 |         name: "nikhil",
  50 |         email: `nikhil${Date.now()}@gmail.com`,
  51 |         status: 'active',
  52 |         gender: 'male'
  53 |     }
  54 | 
  55 |     const response=await request.post(`${BASE_URL}/$(userID}`,{headers,
  56 |         data: requestbody
  57 |     })
> 58 | expect(response.status()).toBe(201)
  ...
  62 | })
  63 | 
  64 | //npx playwright test tests/gorest.spec.ts
```